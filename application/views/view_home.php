...
<head>
	...
	<script type="text/javascript" src=<?php echo base_url() . "public/dist/jquery.js"; ?>></script>
	<script type="text/javascript" src=<?php echo base_url() . "public/dist/semantic.js"; ?>></script>
	<script type="text/javascript" src=<?php echo base_url() . "public/dist/homepage.js"; ?>></script>
</head>
			...
			<div class="column">
				<div class="ui menu">
					...
					<div class="right menu">
						...
						<a class="left active blue item">Home</a>
						<a class="blue item">Home</a>
						<a class="blue item">Home</a>
						<a class="blue item">Home</a>
						<a class="blue item">Home</a>
						<a class="blue item">Home</a>
						<div class="ui dropdown link blue item">Demo
							<i class="dropdown icon"></i>
							<div class="menu">
							<a class="item">A</a>
							<a class="item">B</a>
						...
						<a class="blue item">Contact Us</a>
					</div>
				</div>
				
				<img src=<?php echo base_url() . "public/dist/logo.png"; ?> class="ui medium image">
